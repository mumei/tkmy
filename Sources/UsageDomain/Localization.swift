...
public enum L10n {
    ...
    private static let translations: [String: [String]] = [
        ...
        "quota_since_previous_format": ["%@ since previous", "前回から%@", "%@ seit vorheriger Beobachtung", "距上次 %@", "%@ depuis le relevé précédent", "이전 기록 후 %@", "%@ desde la observación anterior", "%@ dalla rilevazione precedente", "%@ kể từ lần ghi nhận trước", "%@ จากรายการก่อนหน้า"],
        "quota_first_observation": ["First observation", "最初の観測", "Erste Beobachtung", "首次观测", "Premier relevé", "첫 기록", "Primera observación", "Prima rilevazione", "Lần ghi nhận đầu tiên", "การบันทึกครั้งแรก"],
        ...
        "quota_token_details": ["Token estimate details", "トークン換算の詳細", "Details zur Tokenschätzung", "令牌估算详情", "Détails de l’estimation des jetons", "토큰 추정 상세", "Detalles de la estimación de tokens", "Dettagli della stima dei token", "Chi tiết ước tính token", "รายละเอียดการประเมินโทเค็น"],
        ...
        "quota_chart_a11y": ["Remaining quota chart from 0 to 100 percent. Lines connect observations for reference; the latest value may extend to now, up to a known reset. Resets and recoveries are not joined.", "残量を0〜100%で表示するグラフ。線は観測点の間をつないだ参考表示です。最終確認後は最新値を延長し、リセット・残量回復の前後はつなぎません。", "Diagramm des Restkontingents von 0 bis 100 Prozent. Linien verbinden Beobachtungen zur Orientierung; der letzte Wert kann bis jetzt, höchstens bis zu einem bekannten Reset, verlängert werden. Resets und Erholungen werden nicht verbunden.", "显示 0 到 100% 剩余额度的图表。线条用于参考地连接观测值；最后一个值可延长至当前时间，至多延长到已知重置。重置和恢复不会连接。", "Graphique du quota restant de 0 à 100 pour cent. Les lignes relient les relevés à titre de référence ; la dernière valeur peut se prolonger jusqu’à maintenant, au plus jusqu’à une réinitialisation connue. Les réinitialisations et récupérations ne sont pas reliées.", "0~100% 남은 할당량 차트입니다. 선은 참고용으로 관측값을 연결하며, 최신 값은 알려진 재설정 전까지 현재 시점으로 연장될 수 있습니다. 재설정과 회복은 연결하지 않습니다.", "Gráfico de cuota restante de 0 a 100 por ciento. Las líneas conectan las observaciones como referencia; el último valor puede extenderse hasta ahora, como máximo hasta un reinicio conocido. Los reinicios y las recuperaciones no se unen.", "Grafico della quota residua da 0 a 100 percento. Le linee collegano le osservazioni come riferimento; l’ultimo valore può estendersi fino a ora, al massimo fino a un ripristino noto. Ripristini e recuperi non sono collegati.", "Biểu đồ hạn mức còn lại từ 0 đến 100 phần trăm. Các đường nối các lần ghi nhận để tham khảo; giá trị mới nhất có thể kéo dài đến hiện tại, tối đa đến thời điểm đặt lại đã biết. Việc đặt lại và hồi phục không được nối.", "กราฟโควต้าคงเหลือจาก 0 ถึง 100 เปอร์เซ็นต์ เส้นเชื่อมค่าที่บันทึกไว้เพื่ออ้างอิง ค่าล่าสุดอาจต่อถึงเวลาปัจจุบันได้ แต่ไม่เกินเวลาการรีเซ็ตที่ทราบ การรีเซ็ตและการฟื้นกลับจะไม่เชื่อมกัน"],
        "quota_chart_gap_note": ["Lines connect observations for reference. The latest value may extend to now, up to a known reset. Resets and recoveries are not joined.", "線は観測点の間をつないだ参考表示です。最終確認後は最新値を延長し、リセット・残量回復の前後はつなぎません。", "Linien verbinden Beobachtungen zur Orientierung. Der letzte Wert kann bis jetzt, höchstens bis zu einem bekannten Reset, verlängert werden. Resets und Erholungen werden nicht verbunden.", "线条用于参考地连接观测值。最后一个值可延长至当前时间，至多延长到已知重置。重置和恢复不会连接。", "Les lignes relient les relevés à titre de référence. La dernière valeur peut se prolonger jusqu’à maintenant, au plus jusqu’à une réinitialisation connue. Les réinitialisations et récupérations ne sont pas reliées.", "선은 참고용으로 관측값을 연결합니다. 최신 값은 알려진 재설정 전까지 현재 시점으로 연장될 수 있습니다. 재설정과 회복은 연결하지 않습니다.", "Las líneas conectan las observaciones como referencia. El último valor puede extenderse hasta ahora, como máximo hasta un reinicio conocido. Los reinicios y las recuperaciones no se unen.", "Le linee collegano le osservazioni come riferimento. L’ultimo valore può estendersi fino a ora, al massimo fino a un ripristino noto. Ripristini e recuperi non sono collegati.", "Các đường nối các lần ghi nhận để tham khảo. Giá trị mới nhất có thể kéo dài đến hiện tại, tối đa đến thời điểm đặt lại đã biết. Việc đặt lại và hồi phục không được nối.", "เส้นเชื่อมค่าที่บันทึกไว้เพื่ออ้างอิง ค่าล่าสุดอาจต่อถึงเวลาปัจจุบันได้ แต่ไม่เกินเวลาการรีเซ็ตที่ทราบ การรีเซ็ตและการฟื้นกลับจะไม่เชื่อมกัน"],
